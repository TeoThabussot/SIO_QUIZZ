...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $data = [
            ...
            "Les Pokémons" => [
                ...
                "Laquelle de ces affirmations est fausse ?" => [
                    "Lugia et Ho-oh sont les Pokémon responsables du cycle jour/nuit" => false,
                    "Palkia est le maître de l'espace" => false,
                    "Reshiram et Zekrom sont inspirés du Yin et du Yang" => false,
                    "Solgaléo et Lunala sont les seuls Légendaires à être évolués" => true
                ],
        ...
        foreach ($data as $libelleTheme => $themeData) {
            $theme = new Theme();
            $theme->setLibelle($libelleTheme);

            foreach ($themeData as $libelleQuestion => $questionData) {
                ...
                foreach ($questionData as $libelleResponse => $responseValue)  {
                    $response = new Response();
                    $response->setLibelle($libelleResponse);
                    $response->setCorrect($responseValue);
